...
- [ ] New address live
- [ ] Owner can mint cooker/merchant test balances
- [ ] Non-owner mint reverts
- [ ] Pay → verify → fulfill still works
...
- [ ] Two public UI URLs + API `/health`
- [ ] External tryout possible without laptop localhost
...
3. Store in env + README:
   ...
   - `ERC8004_AGENT_URI`
   - `ERC8004_TX_HASH`
4. Check https://testnet.8004scan.io/
